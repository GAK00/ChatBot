...
public class ChatViewer {
	...
	/**
	 * Creates an input popup to collect response from user as a string, and also displays a pictue.
	 * @param question The question to ask the user.
	...
	public String  collectUserTextWithPics(String question, String fileName){
		...
		userInput = JOptionPane.showInputDialog(null, question, windowMessage, JOptionPane.DEFAULT_OPTION, chatIcon, null, "Type here please!").toString();
	 ...
	 * @param message The message to be placed in the popup.
	 * @param fileName the file location for the picture
	 */
